...
**Purpose:** Defines the unified, semantic, tag-based decorator system used across all Morph UI elements (tables, rows, fields, cards, wizard steps, etc.). Decorators provide semantic meaning without embedding logic or visual styling into metadata.
